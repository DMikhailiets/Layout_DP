...
_smap("Specular Mask", 2D) = "black" {}
_scolor("Specular Color", Color) = (1,1,1,1)
_srange("Specular Glossiness", Range(0,1) ) = 1
...
float4 Tex2D1=tex2D(_smap,(IN.uv_smap.xyxy).xy);
float4 Multiply2=_scolor * Tex2D1;
